...
module {
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %resultEdges0 = subop.gather %resultEdges @edges::@toRef {node_id2 => @nodes2::@id({type = i64})}

            %0 = subop.create !subop.result_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64]>
            subop.materialize %resultEdges0 {@edges::@id => int64p0, @nodes2::@id => int64p1, @edges::@property => int64p2}, %0 : !subop.result_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64]>
            %res = subop.create_from ["int64", "int64", "int64"] %0 : !subop.result_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64]> -> !subop.local_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64], ["int64", "int64", "int64"]>
            subop.execution_group_return %res : !subop.local_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64], ["int64", "int64", "int64"]>
        
        } -> !subop.table<[int64n0 : i64, int64n1 : i64, int64n2 : i64]>
        subop.set_result 0 %subop_result : !subop.table<[int64n0 : i64, int64n1 : i64, int64n2 : i64]>
        return
    }
}