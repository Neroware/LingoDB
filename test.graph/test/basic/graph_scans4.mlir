module {
    func.func @main() {
    	%subop_result = subop.execution_group (){
            ...
            %resultEdges = subop.gather %ex @edges::@ref {edge_id => @edges::@id({type = i64}), to => @edges::@toRef({type = !graph.node_ref<[node_id2 : i64],[incoming2 : !graph.edge_set<[incoming_it2 : !graph.graph_set_iterator<["incoming"]>]>],[outgoing2 : !graph.edge_set<[outgoing_it2 : !graph.graph_set_iterator<["outgoing"]>]>],[property2 : i64]>})}
            ...
            subop.materialize %resultEdges0 {@edges::@id => int64p0, @nodes2::@id => int64p1}, %0 : !subop.result_table<[int64p0 : i64, int64p1 : i64]>
            %res = subop.create_from ["int64", "int64"] %0 : !subop.result_table<[int64p0 : i64, int64p1 : i64]> -> !subop.local_table<[int64p0 : i64, int64p1 : i64], ["int64", "int64"]>
            subop.execution_group_return %res : !subop.local_table<[int64p0 : i64, int64p1 : i64], ["int64", "int64"]>
        
        } -> !subop.local_table<[int64p0 : i64, int64p1 : i64], ["int64", "int64"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int64p0 : i64, int64p1 : i64], ["int64", "int64"]>
        return
    }
}