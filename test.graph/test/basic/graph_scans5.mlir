module {
    func.func @main() {
        ...
        } -> !subop.local_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64], ["int64", "int64", "int64"]>
        subop.set_result 0 %subop_result : !subop.local_table<[int64p0 : i64, int64p1 : i64, int64p2 : i64], ["int64", "int64", "int64"]>
        return
    }
}